...
const BollywoodPage = () => {
   const [movies, setBollywoodContent] = useState([]);
    ...
    useEffect(() => {
        const fetchBollywoodContent = async () => {
            ...
            try {
                ...
                const bollywoodOnly = data.filter((movie) => movie.industry === "bollywood");
                setBollywoodContent(bollywoodOnly.reverse());
            } catch (error) {
...
<div className="nav-buttons">
  ...
  Simply <strong>Comment on Post</strong> if you found any Broken Link; we will fix it for you within the next 24 Hours with Guaranteed and Great Support.
                ...
                <h1 className='C-1'>Bollywood Movies</h1>
